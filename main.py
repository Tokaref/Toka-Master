...
class fichier:
    def __init__(self):
        fichier = open('{}'.format(h1.Nom) + "{}".format(h1.prenom) + ".txt", "w")
        fichier.write(f"\n ----------------------------------------------------------------------------------------------------------------------------------")
        fichier.write(f"\n  /$$$$$$$$ /$$$$$$  /$$   /$$  /$$$$$$        /$$      /$$  /$$$$$$   /$$$$$$  /$$$$$$$$ /$$$$$$$$ /$$$$$$$")
        ...
        fichier.write("\n [DOMAINE PERSO] = " + '{}'.format(h1.Nom) + '{}'.format(h1.prenom) + "-" + "@" + '{}'.format(h1.domaine))
        fichier.write("\n [DOMAINE PERSO] = " + '{}'.format(h1.prenom) + '{}'.format(h1.Nom) + "-" + "@" + '{}'.format(h1.domaine))
        fichier.write("\n [DOMAINE PERSO] = " + '{}'.format(h1.Nom)+ "_" + '{}'.format(h1.prenom)+ "@" + '{}'.format(h1.domaine))
        fichier.write("\n [DOMAINE PERSO] = " + '{}'.format(h1.prenom)+ "_" + '{}'.format(h1.Nom)  + "@" + '{}'.format(h1.domaine))
        fichier.write("\n [DOMAINE PERSO] = " + '{}'.format(h1.Nom)  + "-" + '{}'.format(h1.prenom) + "@" + '{}'.format(h1.domaine))
        fichier.write("\n [DOMAINE PERSO] = " + '{}'.format(h1.prenom)  + "-" +   '{}'.format(h1.Nom) + "@" + '{}'.format(h1.domaine))
        fichier.write("\n [DOMAINE PERSO] = " + '{}'.format(h1.prenom) +'{}'.format(h1.Nom) + "pro"+ "@" + '{}'.format(h1.domaine))
        fichier.write("\n [DOMAINE PERSO] = " + '{}'.format(h1.Nom) +'{}'.format(h1.prenom) + "pro" + "@" + '{}'.format(h1.domaine))
        fichier.write(f"\n            ")
        ...
        fichier.write("\n [GMAIL] = " + '{}'.format(h1.Nom) + '{}'.format(h1.prenom) + "-" + "@" + "gmail.com")
        fichier.write("\n [GMAIL] = " + '{}'.format(h1.prenom) + '{}'.format(h1.Nom) + "-" + "@" + "gmail.com")
        fichier.write("\n [GMAIL] = " + '{}'.format(h1.Nom)+ "_" + '{}'.format(h1.prenom)+ "@" + "gmail.com")
        fichier.write("\n [GMAIL] = " + '{}'.format(h1.prenom)+ "_" + '{}'.format(h1.Nom)  + "@" + "gmail.com")
        fichier.write("\n [GMAIL] = " + '{}'.format(h1.Nom)  + "-" + '{}'.format(h1.prenom) + "@" + "gmail.com")
        fichier.write("\n [GMAIL] = " + '{}'.format(h1.prenom)  + "-" +   '{}'.format(h1.Nom) + "@" + "gmail.com")
        fichier.write("\n [GMAIL] = " + '{}'.format(h1.prenom) +'{}'.format(h1.Nom) + "pro" "@" + "gmail.com")
        fichier.write("\n [GMAIL] = " + '{}'.format(h1.Nom) +'{}'.format(h1.prenom) + "pro" + "@" + "gmail.com")
        fichier.write(f"\n            ")
        ...
        fichier.write("\n [ICLOUD] = " + '{}'.format(h1.Nom) + '{}'.format(h1.prenom) + "-" + "@" + "icloud.com")
        fichier.write("\n [ICLOUD] = " + '{}'.format(h1.prenom) + '{}'.format(h1.Nom) + "-" + "@" + "icloud.com")
        fichier.write("\n [ICLOUD] = " + '{}'.format(h1.Nom)+ "_" + '{}'.format(h1.prenom)+ "@" + "icloud.com")
        fichier.write("\n [ICLOUD] = " + '{}'.format(h1.prenom)+ "_" + '{}'.format(h1.Nom)  + "@" + "icloud.com")
        fichier.write("\n [ICLOUD] = " + '{}'.format(h1.Nom)  + "-" + '{}'.format(h1.prenom) + "@" + "icloud.com")
        fichier.write("\n [ICLOUD] = " + '{}'.format(h1.prenom)  + "-" +   '{}'.format(h1.Nom) + "@" + "icloud.com")
        fichier.write("\n [ICLOUD] = " + '{}'.format(h1.prenom) +'{}'.format(h1.Nom) + "pro" "@" + "icloud.com")
        fichier.write("\n [ICLOUD] = " + '{}'.format(h1.Nom) +'{}'.format(h1.prenom) + "pro" + "@" + "icloud.com")
        fichier.write(f"\n            ")
        ...
        fichier.write("\n [YAHOO] = " + '{}'.format(h1.Nom) + '{}'.format(h1.prenom) + "-" + "@" + "yahoo.fr")
        fichier.write("\n [YAHOO] = " + '{}'.format(h1.prenom) + '{}'.format(h1.Nom) + "-" + "@" + "yahoo.fr")
        fichier.write("\n [YAHOO] = " + '{}'.format(h1.Nom)+ "_" + '{}'.format(h1.prenom)+ "@" + "yahoo.fr")
        fichier.write("\n [YAHOO] = " + '{}'.format(h1.prenom)+ "_" + '{}'.format(h1.Nom)  + "@" + "yahoo.fr")
        fichier.write("\n [YAHOO] = " + '{}'.format(h1.Nom)  + "-" + '{}'.format(h1.prenom) + "@" + "yahoo.fr")
        fichier.write("\n [YAHOO] = " + '{}'.format(h1.prenom)  + "-" +   '{}'.format(h1.Nom) + "@" + "yahoo.fr")
        fichier.write("\n [YAHOO] = " + '{}'.format(h1.prenom) +'{}'.format(h1.Nom) + "pro" "@" + "yahoo.fr")
        fichier.write("\n [YAHOO] = " + '{}'.format(h1.Nom) +'{}'.format(h1.prenom) + "pro" + "@" + "yahoo.fr")
