...
class fichier:
    def __init__(self):
        ...
        fichier.write("\n [ICLOUD] = " + '{}'.format(h1.prenom) + '{}'.format(h1.Nom) + "-" + "@" + "icloud.com")
        fichier.write(f"\n            ")
        fichier.write("\n [ICLOUD] = " +'{}'.format(h1.Nom) + "@" + "yahoo.fr")
        fichier.write("\n [ICLOUD] = " +'{}'.format(h1.prenom) + "@" + "yahoo.fr")
        fichier.write("\n [ICLOUD] = " + '{}'.format(h1.prenom) +'{}'.format(h1.Nom) + "@" + "yahoo.fr")
        fichier.write("\n [ICLOUD] = " + '{}'.format(h1.Nom) +'{}'.format(h1.prenom) + "@" + "yahoo.fr")
        fichier.write("\n [ICLOUD] = " + '{}'.format(h1.prenom) +"." + '{}'.format(h1.Nom) + "@" + "yahoo.fr")
        fichier.write("\n [ICLOUD] = " + '{}'.format(h1.Nom) +"." + '{}'.format(h1.prenom) + "@" + "")
        fichier.write("\n [ICLOUD] = " + '{}'.format(h1.Nom) + '{}'.format(h1.prenom) + "_" + "@" + "yahoo.fr")
        fichier.write("\n [ICLOUD] = " + '{}'.format(h1.prenom) + '{}'.format(h1.Nom) + "_" + "@" + "yahoo.fr")
        fichier.write("\n [ICLOUD] = " + '{}'.format(h1.Nom) + '{}'.format(h1.prenom) + "-" + "@" + "yahoo.fr")
        fichier.write("\n [ICLOUD] = " + '{}'.format(h1.prenom) + '{}'.format(h1.Nom) + "-" + "@" + "yahoo.fr")
